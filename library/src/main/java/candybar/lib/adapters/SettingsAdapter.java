            ...
            if (id == R.id.container) {
                ...
                switch (setting.getType()) {
                    ...
                    case RESET_TUTORIAL:
                        ...
                        Preferences.get(mContext).setPrivacyPolicyAccepted(false);
                        // Reset request consent
                        Preferences.get(mContext).setRequestConsentAccepted(false);

                        Toast.makeText(mContext, R.string.pref_others_reset_tutorial_reset, Toast.LENGTH_LONG).show();
                        
                        // Recreate activity to show privacy policy dialog
                        ((Activity) mContext).recreate();
                        break;
                }
            }
