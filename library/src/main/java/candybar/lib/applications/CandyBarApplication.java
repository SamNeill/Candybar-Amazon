...
public abstract class CandyBarApplication extends Application {
    ...
    public void onCreate() {
        ...
        // Set navigation style from configuration
        String configStyle = getString(R.string.navigation_view_style);
        mConfiguration.setNavigationViewStyle(
            "bottom_navigation".equals(configStyle) ? 
            NavigationViewStyle.BOTTOM_NAVIGATION : 
            NavigationViewStyle.SIDE_NAVIGATION
        );
    ...
    public static class Configuration {
        ...
        private NavigationViewStyle mNavigationViewStyle = NavigationViewStyle.SIDE_NAVIGATION;
        ...
        public Configuration setNavigationViewStyle(@NonNull NavigationViewStyle navigationViewStyle) {
            mNavigationViewStyle = navigationViewStyle;
            return this;
        }
        ...
        public NavigationViewStyle getNavigationViewStyle() {
            return mNavigationViewStyle;
        }
    }
