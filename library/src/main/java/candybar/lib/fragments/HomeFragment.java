...
public class HomeFragment extends Fragment implements HomeListener {
    ...
    private void initHome() {
        ...
        // Only show dimension/random icon when using sidebar navigation
        if (!isBottomNav && CandyBarMainActivity.sHomeIcon != null && requireActivity().getResources().getBoolean(R.bool.show_random_icon)) {
