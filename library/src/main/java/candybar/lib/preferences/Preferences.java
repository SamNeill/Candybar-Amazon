...
public class Preferences {
    ...
    private static final String KEY_REQUEST_CONSENT_ACCEPTED = "request_consent_accepted";
    ...
    public void clearPreferences() {
        ...
        // Always reset privacy policy and request consent when preferences are cleared
        setPrivacyPolicyAccepted(false);
        setRequestConsentAccepted(false);
    }
    ...
    public boolean isIntroReset() {
        // Always return false to prevent intro from showing
        return false;
    }

    public void setIntroReset(boolean introReset) {
        // Disable intro reset functionality
    }
    ...
    private static final String KEY_REGULAR_REQUEST_COUNT = "regular_request_count";

    public int getRegularRequestCount() {
        return getSharedPreferences().getInt(KEY_REGULAR_REQUEST_COUNT, 0);
    }

    public void setRegularRequestCount(int count) {
        getSharedPreferences().edit().putInt(KEY_REGULAR_REQUEST_COUNT, count).apply();
    }

    private static final String KEY_WALLPAPERS_LOADED = "wallpapers_loaded";

    public boolean isWallpapersLoaded() {
        return getSharedPreferences().getBoolean(KEY_WALLPAPERS_LOADED, false);
    }

    public void setWallpapersLoaded(boolean loaded) {
        getSharedPreferences().edit().putBoolean(KEY_WALLPAPERS_LOADED, loaded).apply();
    }

    public boolean isPrivacyPolicyAccepted() {
        return getSharedPreferences().getBoolean(PRIVACY_POLICY_ACCEPTED, false);
    }

    public void setPrivacyPolicyAccepted(boolean accepted) {
        getSharedPreferences().edit().putBoolean(PRIVACY_POLICY_ACCEPTED, accepted).apply();
    }

    public boolean isRequestConsentAccepted() {
        return getSharedPreferences().getBoolean(KEY_REQUEST_CONSENT_ACCEPTED, false);
    }

    public void setRequestConsentAccepted(boolean accepted) {
        getSharedPreferences().edit().putBoolean(KEY_REQUEST_CONSENT_ACCEPTED, accepted).apply();
    }
}
